...
function Router() {
  return <Switch><Route path="/" component={Home} /><Route path="/opportunities" component={Home} /><Route path="/asset/:assetId" component={Home} /><Route path="/decision" component={Home} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
