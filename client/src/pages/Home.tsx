...
export default function Home() {
  ...
  return <div className="min-h-screen bg-[#060a12] text-slate-100 selection:bg-cyan-300/30">
    <AssetIntelligencePanel row={selected} open={assetIntelligenceOpen} onOpenChange={setAssetIntelligenceOpen} onPaperTrade={row => { setPaperAsset(row); setPaperOpen(true); }} />
