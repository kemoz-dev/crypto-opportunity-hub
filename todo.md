...
- [ ] Run full validation, controlled read-only local and production evidence checks, mobile/PWA visual verification, documentation, TODO review, checkpoint publication, and an exact Phase 8 result/blocker report with no artificial trades or data manipulation.
